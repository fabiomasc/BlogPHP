...
<body>
  <!-- Aqui entra a navbar -->
  <nav class="navbar navbar-expand-lg" style="background-color:rgba(255, 165, 0);">
    <div class="container">
      <a href="index.php"><img src="images/esportes-com-bolas.png" alt="" width="50px" heigth="50px"></a>
